...
## Scraping Lyrics: Extracting Genius IDs for songs and their URLs
...
clean_lyrics_tr <- function(lyrics) {
  ...
  lyrics <- str_replace_all(lyrics, "\\[.*?\\]", "")  # Remove content in []
...
# Needed to create a list of custom stop words 
